        ...
        <div class="song_side">
            <nav>
                ...
                <div class="search">
                    ...
                    <input type="text" placeholder="Search Local Music.....">
                    ...
                    <div class="search_result">
                        ...
                        <div class="search-container">
                            <input type="text" id="searchInput" placeholder="Search External Music..."
                                class="search-bar">
                            <button id="searchButton" class="search-button"> <i class="bi bi-search"></i></button>

                        </div>
                        <div id="musicResults" class="results-list">
            ...
            <div class="popular_artist">
                ...
                <div class="item Artist">
                    <li>
                        <a href="narendra.php"><img src="artist/narendra_negi_ji/poster/negi.jpeg" alt=""></a>
                    </li>
                    <li>
                        <a href="pritam_bhartwaan.php"> <img
                                src="artist/preetam_bharatwan/poster/pritam_bartwaan.jpeg" alt=""></a>
                    </li>
                    <li>
                        <a href="meena_rana.php"><img src="artist/meena_rana/poster/meena rana.jpeg" alt=""></a>
                    </li>
                    <li>
