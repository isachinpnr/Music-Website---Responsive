...
<head>
    ...
    <style>
        header .song_side::before {
            ...
            width: 100%;
            height: 250px;
            background: url('./artist/narendra_negi_ji/poster/negi_bg.png');
            z-index: -1;
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <h1>Narendra Negi - Bhalu Lagdu</h1>
                <div class="buttons">
                    <button>PLAY</button>
            ...
            <div class="popular_artist">
                ...
                <div class="item Artist">
                    <li>
                        <a href="narendra.php"><img src="./artist/narendra_negi_ji/poster/negi.jpeg"
                                alt=""></a>
                    </li>
                    <li>
